...
public class HorizontalListView extends AdapterView<ListAdapter> {
	...
	private void addAndMeasureChild(final View child, int viewPos) {
		...
		// no influence of width and height...
	}
	...
	public synchronized void scrollTo(int x, int mode, boolean isSwitch) {
		// not switch
		int time = 500;
		// switch
		if (isSwitch) {
			switch (mode) {
			case 0:
				time = TaskDataBaseManager.COUNT_DAY * 48;
				break;
			case 1:
				time = TaskDataBaseManager.COUNT_WEEK * 40;
				break;
			case 2:
				time = TaskDataBaseManager.COUNT_MONTH * 32;
				break;
			}
		}
